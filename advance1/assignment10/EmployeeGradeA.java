...
public class EmployeeGradeA {
    private int employeeNo;
    private String employeeName;
    private float customer1Feedback,customer2Feedback,customer3Feedback=-1,averageFeedBack;
    private char grade;

    public EmployeeGradeA(int employeeNo, String employeeName, float customer1Feedback, float customer2Feedback, float customer3Feedback) {
