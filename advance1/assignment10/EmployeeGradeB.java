...
public class EmployeeGradeB {
    ...
    public EmployeeGradeB(int employeeNo, String employeeName, float customer1Feedback, float customer2Feedback, float customer3Feedback) {
